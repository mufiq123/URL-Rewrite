...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "https://mufiqs-url-shortener-79f53253f25f.herokuapp.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "https://mufiqs-url-shortener-79f53253f25f.herokuapp.com/" + this.state.preferedAlias
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    <h3><u>Mufiq's URL Rewriter</u></h3>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder="ex. https://www.mufiqali.com"
                        />
                    </div>
                    <div
                        className={
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Your New URL (Seven Characters or Less)</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">Enter Custom Suffix</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
                                ...
                                type="text" placeholder="ex. Mufiq.A (Optional)"
                            />
                        </div>
                        <div
                            className={
